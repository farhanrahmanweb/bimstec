        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div
                    ...
                    <span class="text-deep-gray alt-font margin-25px-bottom d-inline-block text-medium"
                          style="font-size: 13px;">Secretary General of BIMSTEC</span>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since. Lorem Ipsum has been the
                        industry's standard dummy text ever since. Lorem Ipsum is printing and typesetting simply dummy
                        text.</p>
                    <a href="{{route('secretary-general')}}"
                       class="btn btn-dark-gray btn-small text-extra-small margin-5px-top"> Read More</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="upcoming_events" class="wow fadeIn bg-light-gray">
        <div class="container">
            <div class="row justify-content-center">
                <div
                    class="col-12 col-xl-6 col-md-8 margin-eight-bottom md-margin-40px-bottom sm-margin-30px-bottom text-center">
                    <h5 class="alt-font font-weight-700 text-extra-dark-gray margin-20px-bottom text-uppercase">Upcoming
                        Events</h5>
                    <span
                        class="separator-line-horrizontal-medium-light2 bg-deep-pink d-table mx-auto width-100px"></span>
                </div>
            </div>
                            ...
                            @foreach($upcomingEvents as $key=>$event)
                                ...
                                <div class="col-12 col-lg-4 col-md-6 swiper-slide md-margin-four-bottom">
                                    <div
                                        ...
                                        <a href="{{route('events-get', $event->id)}}"><h6
                                                class="md-margin-15px-bottom sm-margin-20px-bottom" style="
                                                overflow: hidden;
                                               text-overflow: ellipsis;
                                               display: -webkit-box;
                                               -webkit-box-orient: vertical;
                                                -webkit-line-clamp: 2;">{{$event->event_title}}</h6>
                                        </a>
                                        <span
                                        ...
                                        <span
                                            class="text-extra-dark-gray text-small text-uppercase d-block line-height-10 alt-font font-weight-600">
                                    ...
                                    @if($event->event_start_date==$event->event_end_date)
                                            ...
                                            @else
                                                ...
                                                @endphp
                                                {{$sdate->isoFormat('D')}}
                                                -{{$edate->isoFormat('D')}} {{\Carbon\Carbon::parse($event->event_start_date, 'UTC')->isoFormat('MMMM YYYY')}}
                                            @endif
                                </span>
                                    </div>
                                </div>
    ...
    <section id="upcoming_events" class="wow fadeIn bg-light-white">
        <div class="container">
            <div class="row justify-content-center">
                <div
                    class="col-12 col-xl-6 col-md-8 margin-eight-bottom md-margin-40px-bottom sm-margin-30px-bottom text-center">
                    <h5 class="alt-font font-weight-700 text-extra-dark-gray margin-20px-bottom text-uppercase">Past
                        Events</h5>
                    <span
                        class="separator-line-horrizontal-medium-light2 bg-deep-pink d-table mx-auto width-100px"></span>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @if(count($pastEvents)>0)
                            @foreach($pastEvents as $key=>$event)
                                ...
                                <div class="col-12 col-lg-4 col-md-6 swiper-slide md-margin-four-bottom">
                                    <a href="{{route('events-get', $event->id)}}">
                                        <div
                                            class="margin-half-all bg-white box-shadow-light text-center padding-fourteen-all sm-padding-30px-all">
                                            <h6
                                                class="md-margin-15px-bottom sm-margin-20px-bottom"
                                                style="
                                                overflow: hidden;
                                               text-overflow: ellipsis;
                                               display: -webkit-box;
                        ...
                        @else
                            <div class="col-12 col-lg-4 col-md-6 swiper-slide md-margin-four-bottom">
                                <div
                                    class="margin-half-all bg-white box-shadow-light text-center padding-fourteen-all sm-padding-30px-all">
                                    <h4 class="md-margin-15px-bottom sm-margin-20px-bottom">No Past Event</h4>
                                </div>
                            </div>
                    @endif
                    <!-- end testimonial item -->
    ...
    <section id="focus_area" class="wow fadeIn lg-padding-two-lr md-no-padding-lr">
        <div class="container">
            <div class="row justify-content-center">
                <div
                    class="col-12 col-xl-6 col-md-8 margin-eight-bottom md-margin-40px-bottom sm-margin-30px-bottom text-center">
                    <h5 class="alt-font font-weight-700 text-white margin-20px-bottom text-uppercase">Areas of
                        Cooperation</h5>
                ...
                <div class="col-12 col-xl-3 col-md-6 sm-margin-five-bottom wow fadeInLeft last-paragraph-no-margin">
                    <div class="box">
                        <a href="{{route('trade-investment')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/index.png')}}"
                                         alt="">
                                    <span
                                        class="alt-font text-white d-block margin-10px-bottom">Trade & Investment</span>
                ...
                <div class="col-12 col-xl-3 col-md-6 sm-margin-five-bottom wow fadeInLeft last-paragraph-no-margin"
                    ...
                    <div class="box">
                        <a href="{{route('transport-communication')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/world.png')}}"
                                         alt="">
                ...
                <div class="col-12 col-xl-3 col-md-6 sm-margin-five-bottom wow fadeInLeft last-paragraph-no-margin"
                    ...
                    <div class="box lg-no-border-left lg-no-border-top">
                        <a href="{{route('energy')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/renewable-energy.png')}}" alt="">
                    ...
                    <div class="box lg-no-border-top">
                        <a href="{{route('tourism')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/destination.png')}}" alt="">
                ...
                <div class="col-12 col-xl-3 col-md-6 sm-margin-five-bottom wow fadeInLeft last-paragraph-no-margin">
                    <div class="box">
                        <a href="{{route('technology')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/chip.png')}}"
                                         alt="">
                ...
                <div class="col-12 col-xl-3 col-md-6 sm-margin-five-bottom wow fadeInLeft last-paragraph-no-margin"
                    ...
                    <div class="box">
                        <a href="{{route('fisheries')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/icon-3.png')}}"
                                         alt="">
                    ...
                    <div class="box lg-no-border-left lg-no-border-top">
                        <a href="{{route('agriculture')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/harvest.png')}}" alt="">
                ...
                <div class="col-12 col-xl-3 col-md-6 wow fadeInLeft last-paragraph-no-margin" data-wow-delay="0.6s">
                    <div class="box lg-no-border-top">
                        <a href="{{route('public-health')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/heart.png')}}"
                                         alt="">
                    ...
                    <div class="box">
                        <a href="{{route('poverty-alleviation')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/poverty.png')}}" alt="">
                                    <span
                                        class="alt-font text-white d-block margin-10px-bottom">Poverty Alleviation</span>
                                    <div class="details"></div>
                                </figure>
                            </div>
                        </a>
                    ...
                    <div class="box">
                        <a href="{{route('counter-terrorism-transnational-crime')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/counter-t.png')}}" alt="">
                    ...
                    <div class="box lg-no-border-left lg-no-border-top">
                        <a href="{{route('environment-disaster-management')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/environment.png')}}" alt="">
                ...
                <div class="col-12 col-xl-3 col-md-6 wow fadeInLeft last-paragraph-no-margin" data-wow-delay="0.6s">
                    <div class="box lg-no-border-top">
                        <a href="{{route('people-to-people-contact')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom" src="{{asset('frontend/images/images/p-to-p.png')}}"
                                         alt="">
                    ...
                    <div class="box">
                        <a href="{{route('cultural-cooperation')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/cultural.png')}}" alt="">
                                    <span
                                        class="alt-font text-white d-block margin-10px-bottom">Cultural Cooperation</span>
                                    <div class="details"></div>
                                </figure>
                            </div>
                        </a>
                    ...
                    <div class="box">
                        <a href="{{route('climate-change')}}">
                            <div class="content">
                                <figure>
                                    <img class="margin-15px-bottom"
                                         src="{{asset('frontend/images/images/climate.png')}}" alt="">
