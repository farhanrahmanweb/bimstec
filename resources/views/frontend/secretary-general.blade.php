            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="nav nav-tabs alt-font text-uppercase text-small text-center font-weight-600 justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#tab_sec2" data-toggle="tab">Secretary General</a></li>
                ...
                <div class="tab-pane med-text fade in active show Profile" id="tab_sec1">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-10 col-md-10 offset-lg-1 text-justify">
                            ...
                            <a href="#" class="btn btn-very-small btn-dark-gray text-very-small border-radius-4 lg-margin-15px-bottom d-table d-lg-inline-block md-margin-lr-auto"><i class="fab fa-twitter" aria-hidden="true"></i> Follow @profile_person</a>
                        </div>
                    </div>
                </div>
                <!-- end tab content -->
                            ...
                            <div class="row margin-10px-bottom">
                                <div class="col-12 col-md-2 md-margin-30px-bottom last-paragraph-no-margin">
                                    <div class="feature-content padding-10px-all bg-white box-shadow-light lg-padding-20px-all text-center">
                                        <div class="alt-font font-weight-600 text-extra-dark-gray"><span class="text-deep-pink margin-5px-right" style="font-size: 25px;">{{\Carbon\Carbon::parse($statement->date, 'UTC')->isoFormat('Do MMM')}} <br></span> {{\Carbon\Carbon::parse($statement->date, 'UTC')->isoFormat('YYYY')}}</div>
{{--                                        <p>Danmodi, DHAKA</p>--}}
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-10 text-center text-lg-left wow fadeIn">
                                    <div class="feature-content padding-10px-all bg-white box-shadow-light lg-padding-20px-all download_tb">
                                        ...
                                        <a class="text-medium line-height-25 text-medium-gray text-right" href="{{asset('storage/secretary/'.$statement->file)}}" target="_blank"><u>Download</u></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
