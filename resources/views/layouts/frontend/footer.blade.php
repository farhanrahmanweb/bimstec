<footer class="sidebar-wrapper mobile-height footer-center-logo bg-light-gray padding-five-tb sm-padding-30px-tb">
    <div class="container">
        <div class="row">
            <!-- start copyright -->
            <div class="col-lg-4 col-md-5 text-small text-left alt-font sm-margin-15px-bottom">
                ...
                <p class="m-0">BIMSTEC SECRETARIAT House No-N.W.(I)-06, Road No-53,<br>
                    ...
                    Tel: <a href="tel:+880-2-9890096-98">+880-2-9890096-98</a><br>
                    Fax: +880-2-9887565</p>
            </div>
            <!-- end copyright -->
            <!-- start social media -->
            <div class="col-lg-4 col-md-5 text-small text-left alt-font sm-margin-15px-bottom">
                ...
                <ul class="p-md-0 list-style-none">
                    ...
                    <li><a href="http://www.mofa.gov.mm/">Ministry of Foreign Affairs, Myanmar</a></li>
                    <li><a href="https://mofa.gov.np/">Ministry of Foreign Affairs, Nepal</a></li>
                    <li><a href="http://www.mfa.gov.lk/">Ministry of Foreign Affairs, Sri Lanka</a></li>
                    <li><a href="http://www.mfa.go.th/main/en/home">Ministry of Foreign Affairs, Thailand</a></li>
                </ul>
            </div>
            <!-- end social media -->
            <!-- start logo -->
            <div class="col-lg-4 col-md-2 text-center sm-margin-10px-bottom">
                <div class="twitter-wrapper">
                    <a class="twitter-timeline" href="https://twitter.com/BimstecInDhaka?ref_src=twsrc%5Etfw">Tweets by BimstecInDhaka</a>
                </div>
